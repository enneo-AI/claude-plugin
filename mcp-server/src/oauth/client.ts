 ...
 */
export async function getAccessToken(instance: string): Promise<string> {
...
async function refresh(instance: string, refreshToken: string): Promise<TokenResult> {
...
async function authorize(instance: string): Promise<TokenResult> {
  const metadata = await discoverAuthServer(instance);
...
function normalizeTokens(raw: any, fallbackRefresh?: string): TokenResult {
