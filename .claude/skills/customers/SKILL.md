...
| Component | Location |
|-----------|----------|
| Customer identification | `cortex/src/services/customer_identification/service.py` |
| Contract recognition | `mind/Mind/Services/ContractRecognition.php` |
| Contract legitimation | `mind/Mind/Services/ContractLegitimation.php` |
