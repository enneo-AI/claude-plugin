...
| Component | Location |
|-----------|----------|
| Ticket routes | `mind/Mind/Routes/TicketRoute.php` |
| Conversation routes | `mind/Mind/Routes/ConversationRoute.php` |
| Ticket processing | `mind/Mind/Models/TicketTraits/TicketProcessingTrait.php` |
| Auto-processing | `mind/Mind/Models/TicketAutoProcessing.php` |
| Dispatcher | `mind/Mind/Routes/Dispatcher.php` |
